...
One-click finance export → single-page leadership dashboard showing EBIT vs Budget, GP%, fee revenue by team, and RAG project status.
...
- **Commit as your GitHub identity, or Vercel will block the deploy.** Vercel verifies that
  ...
  ```
  git config user.email "240115543+lynayong-lab@users.noreply.github.com"
  git config user.name "lynayong-lab"
  ```
